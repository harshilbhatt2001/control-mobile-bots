...
namespace gazebo
{
  class ModelMeasure : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->rosPub = this->rosNode.advertise<controls::inverted_pendulum_states>("pendulum_states", 1000);
    ...
    {
      angle = this->jointPendulum_->Position(0);
    ...
    private: controls::inverted_pendulum_states msg;
